...
const LEGAL_SPACE = { roles:['pilote de cargo','chevalier de lumiere','technomage','contrebandier','agent du senat','mercenaire stellaire'], hooks:['cherche un cristal rare','doit regler une dette','traque un artefact ancien','evite un ordre autoritaire','protege une caravane','cartographie une nebulose'] };
